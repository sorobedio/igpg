...
#51380224==4096 x 12544
        ...
        datapath = os.path.join(root, f'llmdata/smollm_360_mat_full_mlp.pt')  # 262144
        # datapath = os.path.join(root, f'llmdata/smollm_360_mat_full_.pt')  # 262144
        # datapath = os.path.join(root, f'llmdata/smollm_360_mat_full_self_attn.pt')  # 262144
        #
